                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        new TextFormField(
                          ...
                          decoration:
                              getInputDecoration(hintText: 'ebartile@pesaify.com', labelText: S.of(context).email_address),
                        ...
                        new TextFormField(
                          style: TextStyle(color: Theme.of(context).hintColor),
                          keyboardType: TextInputType.text,
                          decoration: getInputDecoration(hintText: '+256 704 111 071', labelText: S.of(context).phone),
